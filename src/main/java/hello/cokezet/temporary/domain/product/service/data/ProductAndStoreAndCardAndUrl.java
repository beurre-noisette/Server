...
public record ProductAndStoreAndCardAndUrl(
		@Schema(description = "zet 상품 ID", example = "1")
		Long id,
		@Schema(description = "온라인 스토어 상품 ID", example = "6360152106")
		Long storeProductId,
		...
		@Schema(description = "구매하러가기 상품 URL", example = "https://www.11st.co.kr/products/6360152106")
		String productUrl
) {
